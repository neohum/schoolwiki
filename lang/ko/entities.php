...
return [
    ...
    'recently_created_books' => '최근에 만든 하위 업무',
    'recently_created_shelves' => '최근에 만든 하위 업무',
    ...
    'permissions_book_cascade' => '하위 업무에 설정된 권한은 자체 권한이 정의되어 있지 않은 한 하위 챕터와 페이지에 자동으로 계단식으로 적용됩니다.',
    ...
    'shelves_save' => '저장',
    'shelves_books' => '이 업무부서에 있는 하위 업무들',
    'shelves_add_books' => '이 업무부서에 하위 업무 추가',
    'shelves_drag_books' => '하위 업무을 이 하위 업무장에 추가하려면 아래로 드래그하세요',
    'shelves_empty_contents' => '이 업무부서에 하위 업무가 없습니다.',
    'shelves_edit_and_assign' => '업무부서 바꾸기로 하위 업무를 추가하세요.',
    'shelves_edit_named' => '업무부서 편집 :name',
    'shelves_edit' => '업무부서 편집',
    'shelves_delete' => '업무부서 삭제',
    'shelves_delete_named' => '업무부서 삭제 :이름',
    'shelves_delete_explain' => "그러면 ':name'이라는 이름의 서가가 삭제됩니다. 포함된 하위 업무은 삭제되지 않습니다.",
    ...
    'shelves_permissions_cascade_warning' => '업무부서에 대한 권한은 포함된 하위 업무에 자동으로 계단식으로 부여되지 않습니다. 한 권의 하위 업무가 여러 개의 업무부서에 존재할 수 있기 때문입니다. 그러나 아래 옵션을 사용하여 권한을 하위 하위 업무으로 복사할 수 있습니다.',
    'shelves_permissions_create' => '업무부서 만들기 권한은 아래 작업을 사용하여 하위 하위 업무에 대한 권한을 복사하는 데만 사용됩니다. 하위 업무을 만드는 기능은 제어하지 않습니다.',
    'shelves_copy_permissions_to_books' => '권한 맞춤',
    'shelves_copy_permissions' => '실행',
    'shelves_copy_permissions_explain' => '그러면 이 업무부서의 현재 권한 설정이 이 업무부서에 포함된 모든 하위 업무에 적용됩니다. 활성화하기 전에 이 업무부서의 권한에 대한 변경 사항이 모두 저장되었는지 확인하세요.',
    'shelves_copy_permission_success' => '업무부서 권한이 복사됨 :count books',

    // Books
    'book' => '하위 업무',
    'books' => '하위 업무',
    'x_books' => '하위 업무 :count개|총 :count개',
    'books_empty' => '만든 하위 업무가 없습니다.',
    'books_popular' => '많이 읽은 하위 업무',
    'books_recent' => '최근에 읽은 하위 업무',
    'books_new' => '하위 업무 새로 추가',
    'books_new_action' => '하위 업무 새로 추가',
    'books_popular_empty' => '많이 읽은 하위 업무 목록',
    'books_new_empty' => '하위 업무 새로 추가 목록',
    'books_create' => '하위 업무 만들기',
    'books_delete' => '하위 업무 삭제하기',
    'books_delete_named' => ':bookName(을)를 지웁니다.',
    'books_delete_explain' => ':bookName에 있는 모든 문서도 지웁니다.',
    'books_delete_confirmation' => '이 하위 업무을 지울 건가요?',
    'books_edit' => '하위 업무 바꾸기',
    'books_edit_named' => ':bookName(을)를 바꿉니다.',
    'books_form_book_name' => '하위 업무 이름',
    'books_save' => '저장',
    'books_permissions' => '하위 업무 권한',
    'books_permissions_updated' => '권한 저장함',
    'books_empty_contents' => '이 하위 업무와 관련된 문서가 없습니다.',
    'books_empty_create_page' => '문서 만들기',
    'books_empty_sort_current_book' => '읽고 있는 하위 업무 정렬',
    'books_empty_add_chapter' => '챕터 만들기',
    'books_permissions_active' => '하위 업무 권한 허용함',
    'books_search_this' => '이 하위 업무에서 검색',
    'books_navigation' => '목차',
    'books_sort' => '다른 하위 업무들',
    'books_sort_desc' => '하위 업무 내에서 챕터와 페이지를 이동하여 내용을 재구성할 수 있습니다. 다른 하위 업무을 추가하여 하위 업무 간에 챕터와 페이지를 쉽게 이동할 수 있습니다.',
    ...
    'books_sort_show_other' => '다른 하위 업무들',
    'books_sort_save' => '적용',
    'books_sort_show_other_desc' => '여기에 다른 하위 업무을 추가하여 정렬 작업에 포함시키고 하위 업무 간 재구성을 쉽게 할 수 있습니다.',
    'books_sort_move_up' => '위로 이동',
    'books_sort_move_down' => '아래로 이동',
    'books_sort_move_prev_book' => '이전 하위 업무으로 이동',
    'books_sort_move_next_book' => '다음 하위 업무으로 이동',
    'books_sort_move_prev_chapter' => '이전 챕터로 이동',
    'books_sort_move_next_chapter' => '다음 챕터로 이동',
    'books_sort_move_book_start' => '하위 업무 시작 부분으로 이동',
    'books_sort_move_book_end' => '하위 업무의 끝으로 이동',
    'books_sort_move_before_chapter' => '이전 챕터로 이동',
    'books_sort_move_after_chapter' => '챕터 뒤로 이동',
    'books_copy' => '하위 업무 복사하기',
    'books_copy_success' => '하위 업무 복사함',
    ...
    'tags_assigned_books' => '하위 업무에 꼬리표 지정함',
    ...
    'tags_list_empty_hint' => '꼬리표는 에디터 사이드바나 하위 업무, 챕터 또는 업무부서 정보 편집에서 지정할 수 있습니다.',
    'attachments' => '첨부 파일',
    ...
    'profile_not_created_books' => ':userName(이)가 만든 하위 업무 없음',
    ...
    // Conversions
    'convert_to_shelf' => '하위 업무장으로 변환',
    'convert_to_shelf_contents_desc' => '이 하위 업무을 동일한 내용의 새 서가로 변환할 수 있습니다. 이 하위 업무에 포함된 챕터는 새 하위 업무으로 변환됩니다. 이 하위 업무에 챕터에 포함되지 않은 페이지가 포함되어 있는 경우, 이 하위 업무의 이름이 변경되어 해당 페이지가 포함되며 이 하위 업무은 새 서가의 일부가 됩니다.',
    'convert_to_shelf_permissions_desc' => '이 하위 업무에 설정된 모든 권한은 새 서가 및 자체 권한이 적용되지 않은 모든 새 하위 업무에 복사됩니다. 하위 업무에 대한 권한은 하위 업무에 대한 권한처럼 그 안의 콘텐츠로 자동 캐스케이드되지 않는다는 점에 유의하세요.',
    'convert_book' => '하위 업무 변환',
    'convert_book_confirm' => '이 하위 업무을 변환하시겠어요?',
    'convert_undo_warning' => '이 작업은 되돌리기 어렵습니다.',
    'convert_to_book' => '하위 업무으로 변환',
    'convert_to_book_desc' => '이 챕터를 동일한 내용의 새 하위 업무으로 변환할 수 있습니다. 이 장에 설정된 모든 권한은 새 하위 업무에 복사되지만 상위 하위 업무에서 상속된 권한은 복사되지 않으므로 액세스 제어가 변경될 수 있습니다.',
    ...
    'watch_detail_parent_book' => '상위 하위 업무을 통해 보기',
