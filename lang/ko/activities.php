...
return [
    ...
    // Pages
    'page_create'                 => '생성된 하위 업무',
    'page_create_notification'    => '하위 업무가 성공적으로 생성되었습니다.',
    'page_update'                 => '하위 업무 업데이트됨',
    'page_update_notification'    => '하위 업무가 성공적으로 업데이트되었습니다.',
    'page_delete'                 => '삭제된 하위 업무',
    'page_delete_notification'    => '하위 업무가 성공적으로 삭제되었습니다.',
    'page_restore'                => '복구된 하위 업무',
    'page_restore_notification'   => '하위 업무가 성공적으로 복원되었습니다.',
    'page_move'                   => '이동된 하위 업무',
    'page_move_notification'      => '하위 업무가 성공적으로 이동되었습니다.',
    ...
    // Books
    'book_create'                 => '생성된 하위 업무',
    'book_create_notification'    => '하위 업무가 생성되었습니다.',
    'book_create_from_chapter'              => '챕터를 책으로 변환',
    'book_create_from_chapter_notification' => '챕터가 책으로 성공적으로 변환되었습니다.',
    'book_update'                 => '업데이트된 책',
    'book_update_notification'    => '하위 업무가 업데이트되었습니다.',
    'book_delete'                 => '삭제된 책',
    'book_delete_notification'    => '하위 업무가 삭제되었습니다.',
    'book_sort'                   => '정렬된 책',
    'book_sort_notification'      => '하위 업무가 재정렬되었습니다.',

    // Bookshelves
    'bookshelf_create'            => '업무 부서 만들기',
    'bookshelf_create_notification'    => '업무부서를 성공적으로 생성했습니다.',
    'bookshelf_create_from_book'    => '하위 업무를 업무부서으로 변환함',
    'bookshelf_create_from_book_notification'    => '하위 업무를 성공적으로 업무부서로 변환하였습니다.',
    'bookshelf_update'                 => '업무부서 업데이트됨',
    'bookshelf_update_notification'    => '업무부서가 성공적으로 업데이트 되었습니다.',
    'bookshelf_delete'                 => '삭제된 업무부서',
    'bookshelf_delete_notification'    => '업무부서가 성공적으로 삭제되었습니다.',
